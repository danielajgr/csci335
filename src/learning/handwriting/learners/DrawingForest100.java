...
public class DrawingForest100 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest100() {
        super(100, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
